...
public class ReservService {
  ...
  public List<ReservDTO> getReservationClientListById(Long id) {
    return reservMapper.toDTOs(reservRepository
        .findReservsByClientIdAndAndReservationDateCancelGreaterThan(id, new Date()));
  }

  public List<ReservDTO> checkReservedBooksByBookId(List<Long> ids) {
    return reservMapper.toDTOs(reservRepository
        .findReservsByBookIdInAndReservationDateCancelGreaterThanEqual(ids, new Date()));
  }
  ...
  public Integer cancel(Long id, List<Long> listReservId) throws IllegalArgumentException {
    List<Reserv> reservs = reservRepository
        .findReservsByIdInAndReservationDateCancelGreaterThanEqual(listReservId, new Date());
    if (reservs.isEmpty()) {
